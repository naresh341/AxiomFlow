...
var MultiSelectItem = React2.memo(function(props) {
  ...
  return React2.createElement("li", itemProps, React2.createElement("div", checkboxContainerProps, React2.createElement(Checkbox, {
    ref: checkboxRef,
...
var MultiSelect = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var onFilterKeyDown = function onFilterKeyDown2(event) {
    switch (event.code) {
      case "ArrowUp":
        if (props.inline) {
          break;
