...
var Portal = React9.memo(function(inProps) {
  ...
  var _React$useState = React9.useState(props.visible && DomHandler.isClient()), _React$useState2 = _slicedToArray2(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  useMountEffect(function() {
...
var Ripple = React10.memo(React10.forwardRef(function(inProps, ref) {
  var _React$useState = React10.useState(false), _React$useState2 = _slicedToArray3(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
  var inkRef = React10.useRef(null);
  var targetRef = React10.useRef(null);
  ...
  return React10.createElement("span", _extends2({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
//# sourceMappingURL=chunk-CVMZ2S3B.js.map
