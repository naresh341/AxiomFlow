    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-white dark:bg-[#101622] border border-[#dbdfe6] dark:border-[#2d3748] rounded-xl overflow-hidden shadow-sm">
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 text-sm text-[#616f89] dark:text-gray-400">
                      <span className="text-blue-500/70">{wf.triggerIcon}</span>
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-[#f8fafc] dark:bg-white/5 border-t border-[#dbdfe6] dark:border-[#2d3748]">
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 rounded-lg border border-[#dbdfe6] dark:border-[#2d3748] text-[#616f89] dark:text-gray-400 hover:bg-white dark:hover:bg-white/10 transition-colors disabled:opacity-50">
              <ChevronLeft size={16} />
            </button>
            {[1, 2, 3].map((page) => (
              <button
                ...
                className={`w-8 h-8 rounded-lg text-sm font-bold transition-colors ${
                  page === 1
                    ...
                    : "text-[#616f89] dark:text-gray-400 hover:bg-[#f0f2f4] dark:hover:bg-white/5"
                }`}
              >
                {page}
              </button>
            ))}
            <button className="p-2 rounded-lg border border-[#dbdfe6] dark:border-[#2d3748] text-[#616f89] dark:text-gray-400 hover:bg-white dark:hover:bg-white/10 transition-colors">
