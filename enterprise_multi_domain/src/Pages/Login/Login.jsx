      ...
      <main className="grow flex items-center justify-center p-4">
        <div className="w-full max-w-137.5 bg-white dark:bg-[#1a2632] shadow-sm border border-[#dbe0e6] dark:border-slate-800 rounded">
          <div className="px-8 pt-10 pb-4">
            ...
            <h1 className="text-[#111418] dark:text-white text-2xl font-bold leading-tight tracking-tight text-center mb-10">
          ...
          <div className="mt-8 border-t border-[#f0f2f4] dark:border-slate-800 bg-[#fafbfc] dark:bg-slate-800/50 py-4 px-8 rounded-b">
            <div className="flex items-center justify-center gap-2 text-[#617589] dark:text-slate-500 text-xs">
