...
const PendingApprovals = () => {
  ...
  return (
    <div className=" flex w-full h-[calc(100vh-160px)] overflow-hidden bg-[#f6f6f8] dark:bg-[#101622] animate-in fade-in duration-500">
      ...
      <aside
        className={`fixed right-0 top-16 bottom-0 h-[calc(100vh-64px)] w-105 bg-white dark:bg-gray-900 border-l border-[#dbdfe6] dark:border-gray-800 flex flex-col shadow-2xl z-100 transform transition-transform duration-300 ease-in-out ${
