...
const BetaCard = ({ title, id, description, warning, initialStatus }) => (
  <div className="bg-white dark:bg-[#1c2632] border border-slate-200 dark:border-[#2d3a4b] p-6 rounded-xl relative overflow-hidden transition-all hover:shadow-md dark:hover:border-slate-500">
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-2">
        ...
        <select className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-[#2d3a4b] text-slate-700 dark:text-slate-200 text-md rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 outline-none">
          <option>Early Adopter Orgs</option>
          <option>Tier 3 Customers Only</option>
    ...
    <div className="bg-[#f6f7f8] dark:bg-[#101922] font-display text-slate-900 dark:text-slate-100 min-h-screen pb-20 transition-colors duration-300">
      <div className=" mx-auto px-6 py-10">
        ...
        <div className="mb-10 group">
          <div className="flex items-center bg-white dark:bg-[#1c2632] rounded-lg border border-slate-200 dark:border-[#2d3a4b] group-focus-within:border-blue-600 transition-all overflow-hidden shadow-md">
            <div className="text-slate-400 pl-4 flex items-center justify-center">
              <Search size={20} />
            </div>
            <input
              className="w-full bg-transparent border-none text-slate-900 dark:text-white focus:ring-0 placeholder:text-slate-400 dark:placeholder:text-slate-500 px-4 py-4 text-base"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <BetaCard
            ...
            id="experimental_ai_v2"
            description="Automatic trend analysis using current models."
          ...
          <BetaCard
            ...
            id="collab_mesh_v1"
            description="Live presence indicators across dashboard."
            warning="Websocket overhead."
            initialStatus={false}
          />
        </div>
      </div>
