    ...
    <div className="flex-1 flex flex-col h-full bg-[#f6f6f8] dark:bg-[#101622] overflow-hidden">
      ...
      >
        <div className="flex border-b border-[#dbdfe6] dark:border-gray-800 gap-8">
          <Link
            to="/approvals"
            className={`pb-4 pt-4 text-md font-bold transition-all border-b-[3px] ${isPendingPage ? "border-[#135bec] text-[#135bec]" : "border-transparent text-gray-500"}`}
          >
            Pending Approvals
          </Link>
          <Link
            to="/approvals/history"
            className={`pb-4 pt-4 text-md font-bold transition-all border-b-[3px] ${isActive("history") ? "border-[#135bec] text-[#135bec]" : "border-transparent text-gray-500"}`}
          >
            Approval History
          </Link>
        </div>
